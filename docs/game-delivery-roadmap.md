...
- `src/components/board/gameBoardActionHandlers.test.ts`: mock BUY/BUILD 성공 후 `advanceTurn` 호출 테스트 추가
...
- `gameBoardActionHandlers.test.ts`: mock/실서버 모드 혼합 회귀 시나리오 보강
