...
const DEFAULT_CHANCE_DESC_1 = '이런 ㅠㅠㅠㅠ'
...
const CardModal: React.FC<CardModalProps> = ({
  ...
  const resolvedTitle = title ?? (variant === 'event' ? DEFAULT_EVENT_TITLE : DEFAULT_CHANCE_TITLE)
  const resolvedDescriptionLine1 =
    descriptionLine1 ?? (variant === 'event' ? DEFAULT_EVENT_DESC_1 : DEFAULT_CHANCE_DESC_1)
  const resolvedDescriptionLine2 =
    descriptionLine2 ?? (variant === 'event' ? DEFAULT_EVENT_DESC_2 : DEFAULT_CHANCE_DESC_2)
